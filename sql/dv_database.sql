...
START TRANSACTION;
USE `DeliVariety`;
INSERT INTO `DeliVariety`.`DV_MENU` (`item_id`, `item_name`, `item_img`, `price`, `category_id`) VALUES (DEFAULT, 'Pizza Roll', 'menu_snack1.png', 4.70, 1);
INSERT INTO `DeliVariety`.`DV_MENU` (`item_id`, `item_name`, `item_img`, `price`, `category_id`) VALUES (DEFAULT, 'Fries', 'menu_snack2.png', 2.80, 1);
INSERT INTO `DeliVariety`.`DV_MENU` (`item_id`, `item_name`, `item_img`, `price`, `category_id`) VALUES (DEFAULT, 'Bruschetta with Warm Tomatoes', 'menu_snack3.png', 6.30, 1);
INSERT INTO `DeliVariety`.`DV_MENU` (`item_id`, `item_name`, `item_img`, `price`, `category_id`) VALUES (DEFAULT, 'Beef & Potato Croquettes', 'menu_snack4.png', 5.90, 1);
INSERT INTO `DeliVariety`.`DV_MENU` (`item_id`, `item_name`, `item_img`, `price`, `category_id`) VALUES (DEFAULT, 'Brazilian Skirt Steak with Golden Garlic Butter', 'menu_steak1.png', 14.80, 2);
INSERT INTO `DeliVariety`.`DV_MENU` (`item_id`, `item_name`, `item_img`, `price`, `category_id`) VALUES (DEFAULT, 'Cola- Marinated Flank Steak', 'menu_steak2.png', 12.60, 2);
INSERT INTO `DeliVariety`.`DV_MENU` (`item_id`, `item_name`, `item_img`, `price`, `category_id`) VALUES (DEFAULT, 'Home-Cooked Meal of Steak and Potatoes', 'menu_steak3.png', 13.50, 2);
INSERT INTO `DeliVariety`.`DV_MENU` (`item_id`, `item_name`, `item_img`, `price`, `category_id`) VALUES (DEFAULT, 'Stewed Steak', 'menu_steak4.png', 9.80, 2);
INSERT INTO `DeliVariety`.`DV_MENU` (`item_id`, `item_name`, `item_img`, `price`, `category_id`) VALUES (DEFAULT, 'Beef Noodles', 'menu_noodle1.png', 7.80, 3);
INSERT INTO `DeliVariety`.`DV_MENU` (`item_id`, `item_name`, `item_img`, `price`, `category_id`) VALUES (DEFAULT, 'Cold Noodles', 'menu_noodle2.png', 5.60, 3);
INSERT INTO `DeliVariety`.`DV_MENU` (`item_id`, `item_name`, `item_img`, `price`, `category_id`) VALUES (DEFAULT, 'Wok Noodles', 'menu_noodle3.png', 6.90, 3);
INSERT INTO `DeliVariety`.`DV_MENU` (`item_id`, `item_name`, `item_img`, `price`, `category_id`) VALUES (DEFAULT, 'Hot Oil Noddles', 'menu_noodle4.png', 6.40, 3);
INSERT INTO `DeliVariety`.`DV_MENU` (`item_id`, `item_name`, `item_img`, `price`, `category_id`) VALUES (DEFAULT, 'Fried Dumplings', 'menu_dumpling1.png', 5.40, 4);
INSERT INTO `DeliVariety`.`DV_MENU` (`item_id`, `item_name`, `item_img`, `price`, `category_id`) VALUES (DEFAULT, 'Dumplings Regular', 'menu_dumpling2.png', 5.20, 4);
INSERT INTO `DeliVariety`.`DV_MENU` (`item_id`, `item_name`, `item_img`, `price`, `category_id`) VALUES (DEFAULT, 'Soup Dumplings', 'menu_dumpling3.png', 6.30, 4);
INSERT INTO `DeliVariety`.`DV_MENU` (`item_id`, `item_name`, `item_img`, `price`, `category_id`) VALUES (DEFAULT, 'Dumplings Vegeterian', 'menu_dumpling4.png', 4.80, 4);
